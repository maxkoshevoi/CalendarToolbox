...
namespace CalendarToolbox.Helpers
{
    public static class CommandHelper
    {
        ...
        {
            Func<object, bool> formattedCanExecute = canExecute == null ? null : _ => canExecute();
        ...
        public static IAsyncCommand Create<TCanExecute>(
            ...
            bool allowsMultipleExecutions = true)
        {
            Func<object, bool> formattedCanExecute = canExecute == null ? null : arg => canExecute((TCanExecute)arg);
            return new AsyncCommand(action, formattedCanExecute, onException, continueOnCapturedContext, allowsMultipleExecutions);
        }
